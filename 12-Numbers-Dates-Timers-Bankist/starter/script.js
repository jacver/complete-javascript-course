...
// video 176 - implementing dates into bankist App
...
// take the milliseconds from timestamp subtraction then convert to days with the second operation -- absolute value will keep result positive no matter what

const days1 = calcDaysPassed(new Date(2037, 3, 14), new Date(2037, 3, 24));
console.log(`${days1} days`);

// there are date libraries like moment.js to help with harder cases, time changes, daylight savings, etc
*/

// 178 - internationalization API
